...
class Pemeriksaanbalita extends Bidan_Controller
{
    private $services = null;
    private $name = null;
    private $parent_page = 'bidan';
    private $current_page = 'bidan/pemeriksaanbalita/';

    public function __construct()
    {
        parent::__construct();
        $this->load->library('services/pemeriksaanbalita_services');
        $this->services = new pemeriksaanbalita_services;
