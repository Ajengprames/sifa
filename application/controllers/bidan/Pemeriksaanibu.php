...
class Pemeriksaanibu extends Bidan_Controller
{
    private $services = null;
    private $name = null;
    private $parent_page = 'bidan';
    private $current_page = 'bidan/pemeriksaanibu/';

    public function __construct()
    {
        parent::__construct();
        $this->load->library('services/pemeriksaanibu_services');
        $this->services = new pemeriksaanibu_services;
